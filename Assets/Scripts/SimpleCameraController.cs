...
public class SimpleCameraController : MonoBehaviour {
  ...
  public AnimationCurve mouseSensitivityCurve = new AnimationCurve(
      new Keyframe(0f, 0.5f, 0f, 5f), new Keyframe(1f, 2.5f, 0f, 0f));
  ...
  void Start() {
    ...
    boostFactorAction.AddBinding("<Gamepad>/Dpad")
  ...
  bool IsBoostPressed() {
    ...
    bool boost = Keyboard.current != null
                     ...
                     : false;
    boost |=
        Gamepad.current != null ? Gamepad.current.xButton.isPressed : false;
    return boost;
#else
