...
public class PoseEstimationScenario
    : PerceptionScenario<PoseEstimationScenarioConstants> {
  public bool automaticIteration = true;

  bool m_ShouldIterate;

  public void Move() { m_ShouldIterate = true; }
  ...
  protected override bool isIterationComplete =>
      m_ShouldIterate || automaticIteration && currentIterationFrame >= 1;

  protected override bool isScenarioComplete =>
      currentIteration >= constants.totalFrames;
