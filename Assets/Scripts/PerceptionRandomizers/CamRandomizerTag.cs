...
public class CamRandomizerTag : RandomizerTag
{
    ...
    {
        transform.position = new Vector3(originalTranslation.x, yTranslation, originalTranslation.z);
        transform.eulerAngles = new Vector3(originalRotation.x, originalRotation.y, originalRotation.z);
    }
}
